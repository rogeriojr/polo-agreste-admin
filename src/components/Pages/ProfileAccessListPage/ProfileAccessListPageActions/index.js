...
const ProfileAccessListPageActions = ({ rowData, onDeleteRequest }) => {
  ...
  return (
    <>
      ...
      >
        <ActionMenuItem>
          <Link to={`/profile-access/update/${rowData.id}`}>Editar</Link>
        </ActionMenuItem>
...
ProfileAccessListPageActions.propTypes = {
  onDeleteRequest: PropTypes.func,
  rowData: PropTypes.oneOfType([PropTypes.object]).isRequired,
};

ProfileAccessListPageActions.defaultProps = {
  onDeleteRequest: () => {},
};

export default ProfileAccessListPageActions;
