...
const ListProfileClientTableHeader = ({ getFunction, initialValues }) => {
        ...
        <Form>
          <HeaderBoxContainer>
            ...
            <HeaderBoxItem style={{ paddingLeft: 6 }}>
              <Link to="/client/profiles/new">
                <HeaderButton icon="person_add">Cadastrar</HeaderButton>
              </Link>
            </HeaderBoxItem>
          </HeaderBoxContainer>
        </Form>
